...
function Footer() {
    return (
        <>
            <div className='flex flex-col items-center py-5 bg-[#d7d7d7]'>
                <div className='w-[100vw] flex flex-col py-10 lg:flex-row items-center justify-center gap-5 xl:gap-10 px-5'>
                    <div className='w-[100%] lg:w-[40%] h-50 p-2'>
                        <h1 className='text-3xl text-center lg:text-left'>About Magicbricks</h1>
                        <p className='text-center lg:text-justify'>As the largest platform connecting property buyers and sellers, Magicbricks boasts over 2 crore monthly visitors and 15 lakh active property listings. With over 17 years of experience, Magicbricks has evolved into a comprehensive service provider, offering home loans, interiors and expert advice.</p>
                    </div>
                    <div className='w-[100%] lg:w-[40%] h-50 p-2 gap-5 flex flex-col items-center justify-evenly'>
                        <div>
                            <h1 className='text-2xl text-center lg:text-left'>Properties in India</h1>
                            <p className='font-[14px] text-gray-600 text-center lg:text-justify'>Property in New Delhi | Property in Mumbai | Property in Chennai | Property in Pune | Property in Noida | Property in Gurgaon | Property in Bangalore | Property in Ahmedabad</p>
                        </div>
                        <div className='self-center lg:self-start '>
                            <div className="flex items-center gap-4">
                                <div className="social-button">
                                    <a href="https://www.instagram.com/pritam_mandal_77/profilecard/?igsh=MWE5cXF5ZGpxam84eA==" target='_blank'>
                                ...
                                <div className="social-button">
                                    <a href="https://github.com/Pritammandal77" target='_blank'>
                                        <button className="relative w-12 h-12 rounded-full group cursor-pointer">
                                            <div
                                ...
                                <div className="social-button">
                                    <a href="https://www.linkedin.com/in/pritam-mandal-871510281?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target='_blank'>
                                        <button className="relative w-12 h-12 rounded-full group cursor-pointer">
                                            <div
                ...
                <div className='py-8 text-center px-3'>
                    <p>&copy; Copyright 2025 Magicbricks Realty Services Limited.</p>
                </div>
            </div>
